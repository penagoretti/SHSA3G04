...
\begin{enumerate}
  ...
  \begin{itemize}
    ...
    \begin{equation}
        \begin{cases} \text{$H_{0}$:} & \mbox{The prevalence of workers that have acceptable levels of pollutant is \Sexpr{P}} \\ \text{$H_{1}$:} & \mbox{The prevalence of workers that have acceptable levels of pollutant is not \Sexpr{P}} \end{cases}\\
\end{equation}
    We are going to translate the hypothesis statement into mathematical language:
    \begin{equation}
        \begin{cases} \text{$H_{0}$:} & \mbox{$P(E) = \Sexpr{P}$} \\ \text{$H_{1}$:} & \mbox{$P(E) \not= \Sexpr{P}$} \end{cases}\\
    \end{equation}
...
\item Apply \Robject{extest2by2} to data on Example 2 but now using the OR as measure of association. Report the $p$-value.
...
\item Apply \Robject{extest2by2} to data on Example 2, also using the OR as measure of association, but now assuming that data were obtained under a case-control study. Report the $p$-value.
